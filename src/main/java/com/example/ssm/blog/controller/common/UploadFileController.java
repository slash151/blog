package com.example.ssm.blog.controller.common;

import com.alibaba.fastjson.JSON;
import com.example.ssm.blog.dto.ResultVO;
import com.example.ssm.blog.dto.UploadFileVO;
...
public class UploadFileController {
    ...
    public String uploadFile(@Param("file") MultipartFile file) {
        //上传到本地用户目录
        String rootPath = "/Users/example/Documents/uploads";
